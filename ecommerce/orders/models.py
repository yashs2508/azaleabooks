...
class Order(models.Model):
    ...
    code = models.CharField(max_length=10, editable=False, default="ABC" )
    first_name = models.CharField(max_length=10, default="ABC" )
    last_name = models.CharField(max_length=10, default="ABC" )
